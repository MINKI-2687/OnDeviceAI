...
#
# full_adder_4bit_build.tcl: Tcl script for re-creating project '4bit_adder_hw'
#
# Generated by Vivado on Tue Jan 27 04:31:44 +0900 2026
...
#
# 1. This project restoration tcl script (full_adder_4bit_build.tcl) that was generated.
#
...
set _xil_proj_name_ "4bit_adder_hw"
...
set script_file "full_adder_4bit_build.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../OnDeviceAI_Workspace/homework/4bit_adder_hw"]"
...
set files [list \
 [file normalize "${origin_dir}/../rtl/full_adder_4bit.v"] \
]
...
set files [list \
 [file normalize "${origin_dir}/../sim/tb_full_adder_4bit.v"] \
]
add_files -norecurse -fileset $obj $files
